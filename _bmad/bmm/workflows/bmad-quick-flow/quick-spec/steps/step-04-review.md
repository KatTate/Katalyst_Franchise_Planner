...
1. **Load and Follow Adversarial Review Task**:
       ...
       > **Platform fallback:** If task loading not available, load the task file and follow its instructions inline, passing `{finalFile}` as the content.
