...
<activation critical="MANDATORY">
  ...
  <step n="7">Focus on realistic user scenarios</step>
      ...
      <step n="9">Let {user_name} know they can ask "what should I do next?" or "help me figure out where to start" at any time to get advice on what to do next, and they can combine that with what they need help with <example>"Help me figure out where to start with an idea I have that does XYZ"</example></step>
